        ...
        <div class="container">
            <div class="row gy-4">
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="blogCard rounded-2 overflow-hidden">
                        <div class="row h-100">
                            <div class="col-12">
                                <div class="blogImg overflow-hidden rounded-top-2">
                                    <img src="{{ url('public/assets/img/chairBack.jpg')}}" alt="cardImg" class="h-100 w-100 img-fluid">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="content px-3  py-3">
                                    <div class="cardHeading mb-2">
                                        What Is MSME?
                                    </div>
                                    <div class="cardDescription">
                                        MSME stands for Micro, Small and Medium Enterprises, which are entities engaged in the production, manufacturing, processing, or preservation of goods and commodities.
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="cardBtn mt-auto px-3 mb-3">
                                    <button class="btn cardbtnbtn" type="button">Read More</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="col-12">
                                                <div class="cardHeadingmain">
                                                    <a href="javascript;;" class="cardHeading">
                                                        What is the role of MSME in economic growth?
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="cardSubHeading">
                                                    By creating jobs, MSMEs help to reduce unemployment rates and stimulate economic growth. Additionally, entrepreneurship drives innovation and encourages the creation of new industries and markets, leading to further job creation and economic development.
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="row align-items-center justify-content-between pt-3">
